...
2. **Edit to `.context/<stage-artifact>.md`** → target is the agent that produced that artifact (look up via stage-contracts.md: `planning.md` → product-manager, `development.md` → developer, etc.).
