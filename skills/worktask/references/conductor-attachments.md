...
````markdown
<!-- Generated by igrsoft FN stage. worktask_id: <WORKTASK_ID>, ts: <ISO_TS> -->

The igrsoft worktask has finished and is ready to ship.
