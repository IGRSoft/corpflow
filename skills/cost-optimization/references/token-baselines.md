...
| Fast mode (`/fast`) defaults to Opus 4.8 | 2.1.154 | Opus 4.8 fast mode delivers **2x rate for 2.5x speed** — set `CLAUDE_CODE_OPUS_4_6_FAST_MODE_OVERRIDE=1` (deprecated, removed 06/01) only if pinning back to Opus 4.6 |
