...
|-------|-------|-------|-----------------|------------------|------------|------------|
| **PL** | product-manager | opus | User request; trigger flags | `.context/planning.md` with sections: Goal, Scope, Complexity Score, Stage Plan, Approval Required + `.context/designs/figma-registry.md` (if Figma URLs provided) | `planning.md` exists + Complexity Score int 0–50 + Stage Plan lists downstream task subjects | `.context/errors/product-manager.md` |
