...
- **429 `@test`** assertions across the suite (394 baseline + 35: 7 AR->DV gate cases, 4 conditional-edge cases, 4 filename-grammar cases, and pre-existing tracker drift)
