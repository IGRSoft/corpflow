...
- `--platform <apple|android|web|systems|backend|ai|all>` - Platform context (default: auto-detect). The platform's plugin resolves via `skills/shared/routing-matrix.md` (project `CORPFLOW.md § Routing` override wins)
