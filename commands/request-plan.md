...
3. End with exactly one ready-to-paste worktask trigger line (`micro:` / `quick:` / `worktask:`),
   chosen via the canonical tier-selection logic in `skills/estimation/SKILL.md`.
