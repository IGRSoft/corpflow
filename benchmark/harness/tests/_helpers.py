...
calls, returns canned stdout), ThrowAtStageDispatcher (crash at stage N). Injectable
runners for estimate / auth-status / git-sha. make_live_sandbox builds a throwaway
benchmark tree; single_object_usage / stream_json build capture stdout.
"""
