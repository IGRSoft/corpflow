...
|------|----------------|----------------|
| 2.1.234→2.1.251 | cc-features-2.1.234-251.md | v4.0.27 (cross-agent/cross-session comms; delivery-checked reattach; PreModelSwitch gate; min CC → 2.1.251) |
